...
// Source: internal/db/queryextensions/operation_idempotency_operations_ext.sql.go.tmpl
...
claimed AS (
    ...
    SET operation_table = CASE
            WHEN operation_idempotency_keys.operation_table = '' THEN $9
            ELSE operation_idempotency_keys.operation_table
        END,
