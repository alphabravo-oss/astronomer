...
RETURNING id, cluster_id, chart_version_id, release_name, namespace, values_override, status, revision, notes, installed_by_id, request_id, tool_slug, preset_used, created_at, updated_at, drift_detected, drift_detail, drift_checked_at, project_id
`
...
SELECT id, cluster_id, chart_version_id, release_name, namespace, values_override, status, revision, notes, installed_by_id, request_id, tool_slug, preset_used, created_at, updated_at, drift_detected, drift_detail, drift_checked_at, project_id FROM installed_charts
...
SELECT id, cluster_id, chart_version_id, release_name, namespace, values_override, status, revision, notes, installed_by_id, request_id, tool_slug, preset_used, created_at, updated_at, drift_detected, drift_detail, drift_checked_at, project_id FROM installed_charts WHERE id = $1
`
...
SELECT id, cluster_id, chart_version_id, release_name, namespace, values_override, status, revision, notes, installed_by_id, request_id, tool_slug, preset_used, created_at, updated_at, drift_detected, drift_detail, drift_checked_at, project_id FROM installed_charts ORDER BY created_at DESC, id DESC LIMIT $1 OFFSET $2
`
...
SELECT id, cluster_id, chart_version_id, release_name, namespace, values_override, status, revision, notes, installed_by_id, request_id, tool_slug, preset_used, created_at, updated_at, drift_detected, drift_detail, drift_checked_at, project_id FROM installed_charts WHERE cluster_id = $1 ORDER BY created_at DESC LIMIT $2 OFFSET $3
`
...
const listInstalledChartsForDriftSweep = `-- name: ListInstalledChartsForDriftSweep :many
SELECT id, cluster_id, chart_version_id, release_name, namespace, values_override, status, revision, notes, installed_by_id, request_id, tool_slug, preset_used, created_at, updated_at, drift_detected, drift_detail, drift_checked_at, project_id FROM installed_charts
...
const markInstalledChartDrift = `-- name: MarkInstalledChartDrift :exec
UPDATE installed_charts SET
    drift_detected = $2,
    drift_detail = $3,
...
func (q *Queries) MarkInstalledChartDrift(ctx context.Context, arg MarkInstalledChartDriftParams) error {
	_, err := q.db.Exec(ctx, markInstalledChartDrift, arg.ID, arg.DriftDetected, arg.DriftDetail)
	return err
}
