...
SELECT
    ...
    count(*) FILTER (WHERE COALESCE(l.last_heartbeat, latest.last_ping, latest.connected_at, c.created_at) < now() - make_interval(secs => $1::int))::bigint AS stale_heartbeats,
