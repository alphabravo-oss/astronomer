...
var classifiedSecretColumns = map[string]string{
	...
	"031_gitops_webhook_auth.up.sql:webhook_secret_encrypted":         "Fernet-encrypted per-source GitHub webhook signing secret",
	"046_tool_drift_leases.up.sql:decommission_claim_token":           "non-secret ephemeral ownership-fencing nonce",
