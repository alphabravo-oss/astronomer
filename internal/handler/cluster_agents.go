...
func (h *ClusterAgentHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	RespondJSON(w, http.StatusOK, clusterAgentResponse{
		Summary: summary,
		Items:   items,
		Limit:   limit,
		Offset:  offset,
...
func (h *ClusterAgentHandler) buildUpgradePlan(cluster sqlc.Cluster, agent clusterAgentItem, req agentUpgradePlanRequest) agentUpgradePlanResponse {
