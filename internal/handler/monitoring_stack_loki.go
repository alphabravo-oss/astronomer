...
const (
	...
	lokiQuerySecretName       = "astronomer-loki-query-key"
...
func (h *MonitoringHandler) updateSharedLokiMetadataWith(ctx context.Context, q monitoringSharedMutationWriter, backend sqlc.MonitoringBackend, req SharedLokiRequest, status string) error {
	...
	authCfg["sharedLoki"] = map[string]any{
		...
		"managementLoggingEnabled":     boolFromAny(existing[managementLoggingEnabledMetaKey]),
		"managementLoggingOverlayHash": stringFromMap(existing, managementLoggingOverlayHashMetaKey),
