...
func (h *SupportBundleHandler) Download(w http.ResponseWriter, r *http.Request) {
	...
	h.writeDeliveryDiagnostics(r.Context(), zw, collected)
...
// writeDeliveryDiagnostics emits bounded, secret-free control-plane state.
// It intentionally excludes source URLs, credentials, values, manifests,
// conditions/messages, and Kubernetes Secret-shaped objects.
