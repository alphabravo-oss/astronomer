...
func DefaultTriggerRules() []DefaultTriggerRule {
	...
	return []DefaultTriggerRule{
		...
		readOnly("agent_disconnected", "agent_fleet", "warning", DefaultDisconnectGrace, 1),
		readOnly("agent_flapping", "agent_fleet", "warning", DefaultFlapWindow, DefaultFlapCount),
		readOnly("agent_heartbeat_stale", "agent_fleet", "warning", DefaultDisconnectGrace, 1),
		readOnly("agent_auth_registration_failure", "agent_fleet", "critical", 15*time.Minute, 3),
		readOnly("agent_credential_invalid", "agent_fleet", "critical", 15*time.Minute, 1),
		readOnly("agent_downstream_api_unreachable_reported", "agent_fleet", "warning", 10*time.Minute, 1),
		readOnly("agent_version_unsupported", "agent_fleet", "warning", time.Hour, 1),
		readOnly("agent_upgrade_failed_or_stalled", "agent_fleet", "warning", 30*time.Minute, 1),
		readOnly("agent_ingestion_failed", "agent_fleet", "warning", 15*time.Minute, 3),
		readOnly("agent_command_expired", "agent_fleet", "warning", 15*time.Minute, 1),
		...
		readOnly("fleet_simultaneous_disconnect", "agent_fleet", "critical", 5*time.Minute, 1),
