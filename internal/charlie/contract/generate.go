...
//go:generate go run github.com/atombender/go-jsonschema@v0.24.1 -p bridgeschema -o internal/schema/schema.gen.go pinned/schemas/onboarding-v1.schema.json pinned/schemas/capability-v1.schema.json pinned/schemas/finding-v1.schema.json pinned/schemas/alert-delivery-v1.schema.json
