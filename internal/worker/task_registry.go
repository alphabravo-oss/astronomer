...
var taskDescriptors = []TaskDescriptor{
	...
	descriptor(TaskOwnerTunnel, TypeAlertEvaluation, tasks.HandleAlertEvaluation, CapabilityTunnel, CapabilityOutboundHTTP, CapabilityEncryption),
	...
	descriptor(TaskOwnerTunnel, TypeMonitoringReconcile, tasks.HandleMonitoringReconcile, CapabilityTunnel, CapabilityOutboundHTTP, CapabilityEncryption),
...
var scheduledTaskSpecs = []ScheduledTaskSpec{
	...
	scheduled(TaskOwnerTunnel, TypeAlertEvaluation, "@every 60s", "alert rule evaluation"),
	...
	scheduled(TaskOwnerTunnel, TypeMonitoringReconcile, "@every 2m", "monitoring reconciliation"),
