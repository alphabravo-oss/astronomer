...
var sharedMonitoringRoutes = []struct {
	...
	{"grafana_status", http.MethodGet, "/grafana/status/"},
	{"grafana_preview", http.MethodPost, "/grafana/preview/"},
	{"grafana_install", http.MethodPost, "/grafana/install/"},
	{"grafana_upgrade", http.MethodPut, "/grafana/upgrade/"},
	{"grafana_replace", http.MethodPost, "/grafana/replace/"},
	{"grafana_uninstall", http.MethodDelete, "/grafana/uninstall/"},
