    ...
    document = {
        ...
        "compatibility": {
            ...
            "agent_protocol": {
                ...
                "required_capabilities": compatibility["agent_protocol"]["required_capabilities"],
            },
            "agent": {
                "minimum_compatible_version": compatibility["agent"]["minimum_compatible_version"],
                "minimum_supported_version": compatibility["agent"]["minimum_supported_version"],
                "maximum_supported_version_exclusive": compatibility["agent"]["maximum_supported_version_exclusive"],
                "tunnel_protocol_minimum": compatibility["agent"]["tunnel_protocol"]["minimum"],
                "tunnel_protocol_maximum": compatibility["agent"]["tunnel_protocol"]["maximum"],
                "heartbeat_schema_minimum": compatibility["agent"]["heartbeat_schema"]["minimum"],
                "heartbeat_schema_maximum": compatibility["agent"]["heartbeat_schema"]["maximum"],
            },
            "postgresql": {
                "supported_majors": compatibility["postgresql"]["supported_majors"],
                "minimum_upgrade_schema": compatibility["postgresql"]["minimum_upgrade_schema"],
                "target_schema": compatibility["postgresql"]["target_schema"],
                "reversible_through_schema": compatibility["postgresql"]["reversible_through_schema"],
            },
