...
func (r *report) evaluate() {
	...
	// Workload conservation is a property of every measured run, not only of
	// signed certification. Engineering runs must fail visibly when the driver
	// misses its declared rate/window, event production, or mandatory-audit
	// obligations; certification adds provenance and evidence-density gates
	// below rather than changing these numerical semantics.
