...
const EXPECTED_ROUTE_COUNT = 135; // 2026-09-21: removed the dead /dashboard/settings/native-rbac/ redirect stub (P-018 step 8; it duplicated /dashboard/rbac with no UI of its own).
