...
const rows: Array<[string, string]> = [
  ...
  [
    "/dashboard/clusters/c1/image-scans",
    "/dashboard/clusters/$id/image-scans/",
  ],
  [
    "/dashboard/clusters/c1/network-access",
    "/dashboard/clusters/$id/network-access/",
  ],
  [
    "/dashboard/clusters/c1/network-policies",
  ...
  [
    "/dashboard/clusters/c1/service-mesh",
    "/dashboard/clusters/$id/service-mesh/",
  ],
  [
    "/dashboard/clusters/c1/service-mesh/mtls",
  ...
  [
    "/dashboard/clusters/c1/deployments/ns/foo",
  ...
  [
    "/dashboard/clusters/c1/custom-resources",
