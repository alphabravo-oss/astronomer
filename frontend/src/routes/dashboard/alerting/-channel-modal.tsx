...
import { useCreateNotificationChannel } from "@/lib/hooks/alerting";
...
const channelTypeFields: Record<
...
export function NotificationChannelModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5">
        <span
          id="notification-channel-type-label"
          className="text-sm font-medium text-foreground"
        >
          Type
        </span>
        <div
          role="group"
          aria-labelledby="notification-channel-type-label"
