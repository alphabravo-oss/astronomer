                  ...
                  <section className="space-y-2 rounded border p-3 text-sm">
                    ...
                    {d.data.manualRemediation.preconditions.length ? (
                      <div>
                        ...
                        <ul className="list-disc pl-5">
                          {d.data.manualRemediation.preconditions
                            .slice(0, 16)
                            .map((value, index) => (
                    ...
                    <div>
                      ...
                      <ol className="list-decimal pl-5">
                        {d.data.manualRemediation.steps
                          .slice(0, 16)
                          .map((value, index) => (
                    ...
                    <p>
                      <b>Expected impact:</b>{" "}
                      {d.data.manualRemediation.expectedImpact.slice(0, 1024)}
                    </p>
                    {d.data.manualRemediation.rollback ? (
                      <p>
                        <b>Rollback:</b>{" "}
                        {d.data.manualRemediation.rollback.slice(0, 1024)}
                      </p>
                    ) : null}
                    <div>
                      <b className="text-xs">
                        Verification (
                        {d.data.manualRemediation.verificationMethod.slice(
                          0,
                          128,
                        )}
                        )
                      ...
                      <ul className="list-disc pl-5">
                        {d.data.manualRemediation.verificationSteps
                          .slice(0, 16)
                          .map((value, index) => (
                            <li key={index}>{value.slice(0, 512)}</li>
                          ))}
                    ...
                    <p className="text-foreground/70">
                      Recording progress or completion does not authorize
                      Charlie to execute.
                    </p>
                  </section>
                ) : null}
