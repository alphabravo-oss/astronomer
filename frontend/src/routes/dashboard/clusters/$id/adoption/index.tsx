    ...
    <PageShell>
      ...
      <TabsContent active={tab === "overview"} className="space-y-4">
        <div className="grid gap-3 md:grid-cols-3">
          <AdoptionCard title="Register" text="Create the cluster identity and a short-lived installation manifest." />
          <AdoptionCard title="Connect" text="Confirm the agent tunnel and read-only inventory are healthy." />
          <AdoptionCard title="Baseline" text="Apply only the optional platform components selected during registration." />
        </div>
