      ...
      >
        ...
        {component.namespace ? (
          <div className="mt-4 flex flex-wrap gap-3 text-sm">
            <Link
              href={`/dashboard/clusters/${clusterId}/namespaces/${component.namespace}`}
              className="font-medium text-link hover:underline"
            >
              Namespace
            </Link>
            <Link
              href={`/dashboard/clusters/${clusterId}/pods?namespace=${encodeURIComponent(component.namespace)}`}
              className="font-medium text-link hover:underline"
            >
              Pods and logs
            </Link>
            <Link
              href={`/dashboard/clusters/${clusterId}/persistentvolumeclaims?namespace=${encodeURIComponent(component.namespace)}`}
              className="font-medium text-link hover:underline"
            >
              Storage
            </Link>
            <Link
              href={`/dashboard/clusters/${clusterId}/events?namespace=${encodeURIComponent(component.namespace)}`}
              className="font-medium text-link hover:underline"
            >
              Events
            </Link>
