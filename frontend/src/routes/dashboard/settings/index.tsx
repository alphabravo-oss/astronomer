...
const CARDS: SettingsCard[] = [
  {
    ...
    title: "Charlie",
    description:
      "Connect and govern Charlie AI, its product agent, automation, access, and diagnostics.",
    icon: Sparkles,
    charlie: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "Customize subject + body of every transactional email + webhook.",
    icon: FileText,
  },
  {
  ...
  },
  {
    ...
    description:
      "Organize clusters into folders by environment, region, or BU.",
    icon: FolderTree,
  },
  {
    ...
    description:
      "Build a signed ZIP of audit + RBAC + config for a date range.",
    icon: FileArchive,
  },
  {
    ...
    description:
      "Nightly management-plane dump, destination, encryption-key wrapping, restore drill.",
    icon: ShieldCheck,
  },
  {
  ...
  },
  {
    ...
    description:
      "Prometheus sparklines, Grafana panels, and URL iframes pinned to dashboards.",
  ...
  },
  {
    ...
    title: "Extensions",
    description:
      "Manifest validation, permissions review, and enablement controls.",
    icon: Puzzle,
    featureFlag: "feature.extensions",
  },
  {
    ...
    description:
      "HashiCorp Vault sources for ${vault://...} install-time secret refs.",
    icon: KeyRound,
  },
  {
  ...
  },
  {
    ...
    description:
      'Which GET endpoints emit a "who saw what credential" audit row.',
    icon: FileSearch,
  },
  {
    ...
    description:
      "Stream audit + platform events to syslog / Splunk HEC / NDJSON-HTTPS.",
    icon: Radio,
  },
  {
    ...
    description:
      "Shared Thanos + Alertmanager: install, upgrade, replace, uninstall.",
    icon: BarChart3,
  },
  {
    ...
    description:
      "Deny-all / project-isolated / namespace-only Kubernetes NetworkPolicy bundles.",
    icon: Network,
  },
];
  ...
  return (
    <PageShell>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {CARDS.filter((card) => {
          if (card.featureFlag && featureFlags?.[card.featureFlag] !== true)
            return false;
          return isSuperuser
