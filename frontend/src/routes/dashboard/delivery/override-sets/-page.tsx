...
export function OverrideSetsPage() {
  ...
  >();
  const [deleting, setDeleting] = useState<DeliveryOverrideSet | null>(null);
  const pageSize = 20;
  ...
  return (
    ...
    >
        ...
        <PageShell>
          ...
          <PageSection title="Override sets">
            <DataTable
              ...
              emptyState={{
                title: "No configuration overrides",
      ...
      <ConfirmDialog
        ...
        description="Future resolutions will no longer apply this override layer."
...
function OverrideEditor({
  ...
  return (
    <ModalShell
      ...
      onClose={onClose}
    >
      <FormShell onSubmit={submit} className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <label className="space-y-1.5 text-sm">
            ...
            <Select name="scope" defaultValue={item?.scope ?? "project"}>
              {scopes.map((value) => (
