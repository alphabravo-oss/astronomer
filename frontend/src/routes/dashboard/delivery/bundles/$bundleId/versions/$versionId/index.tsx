...
const sensitiveKey = /(password|passwd|token|secret|private.?key|credential|api.?key)/i;
  ...
  return [
    {
      ...
      evidence: version.artifactDigest || version.resolvedRevision || "Resolution pending",
    },
    {
      order: 2,
          ...
          {version.data && (
            <>
              <DetailGrid>
                ...
                />
                <Detail label="Spec digest" value={version.data.specDigest} mono />
              </DetailGrid>
              <PageSection
