...
export const queryKeys = {
  charlie: {
    ...
    sessionStatus: (id?: string | null) =>
      ["charlie", "session", "status", id] as const,
    commands: ["charlie", "commands"] as const,
    threads: ["charlie", "threads"] as const,
    threadHistory: (id?: string | null) =>
      ["charlie", "threads", "history", id] as const,
    history: (id?: string | null) => ["charlie", "history", id] as const,
    contextSearch: (query: string) =>
      ["charlie", "context-search", query] as const,
  ...
  clusters: {
    ...
    nodeDetail: (id: string, nodeName: string) =>
      ["clusters", id, "nodes", nodeName] as const,
    namespaces: (id: string) => ["clusters", id, "namespaces"] as const,
    conditions: (id: string) => ["clusters", id, "conditions"] as const,
    conditionRemediation: (id: string) =>
      ["clusters", id, "condition-remediation"] as const,
    ...
    pods: (id: string, params?: Record<string, unknown>) =>
      ["clusters", id, "pods", params] as const,
    podsAll: (id: string) => ["clusters", id, "pods"] as const,
    metrics: (id: string, range?: string) =>
      ["clusters", id, "metrics", range] as const,
    metricsSummary: (id: string) =>
      ["clusters", id, "metrics", "summary"] as const,
  ...
  clusterPages: {
    ...
    imageVulnProgress: (id: string) =>
      ["clusters", id, "image-vulns", "progress"] as const,
    ...
    mirroredGatewayClasses: (id: string) =>
      ["clusters", id, "mirrored", "gateway-classes"] as const,
    mirroredNetworkPolicies: (id: string) =>
      ["clusters", id, "mirrored", "network-policies"] as const,
    mirroredResourceQuotas: (id: string) =>
      ["clusters", id, "mirrored", "resource-quotas"] as const,
    mirroredLimitRanges: (id: string) =>
      ["clusters", id, "mirrored", "limit-ranges"] as const,
    serviceMeshDetection: (id: string) =>
      ["clusters", id, "service-mesh"] as const,
    serviceMeshInventory: (id: string) =>
      ["clusters", id, "service-mesh", "inventory"] as const,
    serviceMeshMtls: (id: string) =>
      ["clusters", id, "service-mesh", "mtls"] as const,
    veleroStatus: (id: string) => ["clusters", id, "velero-status"] as const,
    snapshots: (id: string) => ["clusters", id, "snapshots"] as const,
    snapshotSchedules: (id: string) =>
      ["clusters", id, "snapshot-schedules"] as const,
    templates: ["cluster-templates"] as const,
    templateBinding: (id: string) => ["clusters", id, "template"] as const,
    workloadKind: (id: string, kind: string) =>
      ["clusters", id, "workloads", kind] as const,
    vulnerabilitySummary: (id: string) =>
      ["clusters", id, "vulnerabilities", "summary"] as const,
    serviceMeshHeader: (id: string) =>
      ["clusters", id, "service-mesh", "header"] as const,
    registrationStatus: (id: string) =>
      ["cluster-registration-status", id] as const,
    registrationManifest: (id: string) =>
      ["clusters", id, "registration-manifest"] as const,
  },
  workloads: {
  ...
  settings: {
    ...
    auditLogs: (params?: Record<string, unknown>) =>
      ["settings", "audit-logs", params] as const,
  ...
  gatekeeperConstraints: (clusterId: string) =>
    ["gatekeeper-constraints", clusterId] as const,
  ...
  anomalyBaselines: {
    ...
    list: (params?: Record<string, unknown>) =>
      ["anomaly-baselines", "list", params] as const,
  ...
  monitoringStack: {
    ...
    // don't clobber one another — the same reasoning used by other paged operation lists.
    operations: (params?: Record<string, unknown>) =>
  ...
  agents: {
    all: ["cluster-agents"] as const,
    list: (params?: Record<string, unknown>) =>
      ["cluster-agents", "list", params] as const,
    diagnostics: (clusterId: string | null) =>
      ["cluster-agents", clusterId, "diagnostics"] as const,
    operations: (clusterId: string | null) =>
      ["cluster-agents", clusterId, "operations"] as const,
  },
  delivery: {
    ...
    sourcesAll: (projectId: string) =>
      ["delivery", projectId, "sources"] as const,
    source: (projectId: string, id: string) =>
      ["delivery", projectId, "sources", "detail", id] as const,
    bundles: (projectId: string, params?: Record<string, unknown>) =>
      ["delivery", projectId, "bundles", params] as const,
    bundlesAll: (projectId: string) =>
      ["delivery", projectId, "bundles"] as const,
    bundle: (projectId: string, id: string) =>
      ["delivery", projectId, "bundles", "detail", id] as const,
    bundleVersions: (
      projectId: string,
      id: string,
    ...
    targetsAll: (projectId: string) =>
      ["delivery", projectId, "targets"] as const,
    target: (projectId: string, id: string) =>
      ["delivery", projectId, "targets", "detail", id] as const,
    preview: (projectId: string, id: string) =>
      ["delivery", projectId, "targets", id, "preview"] as const,
    rollouts: (projectId: string, params?: Record<string, unknown>) =>
      ["delivery", projectId, "rollouts", params] as const,
    rolloutsAll: (projectId: string) =>
      ["delivery", projectId, "rollouts"] as const,
    rollout: (projectId: string, id: string) =>
      ["delivery", projectId, "rollouts", "detail", id] as const,
    rolloutClusters: (
      projectId: string,
      id: string,
      params?: Record<string, unknown>,
    ) => ["delivery", projectId, "rollouts", id, "clusters", params] as const,
    rolloutEvents: (
      projectId: string,
      id: string,
      params?: Record<string, unknown>,
    ) => ["delivery", projectId, "rollouts", id, "events", params] as const,
    deployments: (projectId: string, params?: Record<string, unknown>) =>
      ["delivery", projectId, "deployments", params] as const,
    deploymentsAll: (projectId: string) =>
      ["delivery", projectId, "deployments"] as const,
    deployment: (projectId: string, id: string) =>
      ["delivery", projectId, "deployments", "detail", id] as const,
    deploymentEvents: (
      projectId: string,
      id: string,
      params?: Record<string, unknown>,
    ) => ["delivery", projectId, "deployments", id, "events", params] as const,
    clusterInventory: (projectId: string, clusterId: string) =>
      ["delivery", projectId, "clusters", clusterId, "inventory"] as const,
  },
  extensions: {
  ...
  storage: {
    ...
    storageClasses: (clusterId: string) =>
      ["storage", clusterId, "storageclasses"] as const,
  },
  networking: {
    all: ["networking"] as const,
    services: (clusterId: string) =>
      ["networking", clusterId, "services"] as const,
    ingresses: (clusterId: string) =>
      ["networking", clusterId, "ingresses"] as const,
    networkPolicies: (clusterId: string) =>
      ["networking", clusterId, "networkpolicies"] as const,
    gateways: (clusterId: string) =>
      ["networking", clusterId, "gateways"] as const,
    httpRoutes: (clusterId: string) =>
      ["networking", clusterId, "httproutes"] as const,
    gatewayClasses: (clusterId: string) =>
      ["networking", clusterId, "gatewayclasses"] as const,
    grpcRoutes: (clusterId: string) =>
      ["networking", clusterId, "grpcroutes"] as const,
    tlsRoutes: (clusterId: string) =>
      ["networking", clusterId, "tlsroutes"] as const,
    tcpRoutes: (clusterId: string) =>
      ["networking", clusterId, "tcproutes"] as const,
    udpRoutes: (clusterId: string) =>
      ["networking", clusterId, "udproutes"] as const,
    referenceGrants: (clusterId: string) =>
      ["networking", clusterId, "referencegrants"] as const,
  },
  projects: {
