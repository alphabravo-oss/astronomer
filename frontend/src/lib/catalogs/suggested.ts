...
export const SUGGESTED_CATALOGS: SuggestedCatalog[] = [
  ...
  {
    name: "metrics-server",
    displayName: "Kubernetes Metrics Server",
    url: "https://kubernetes-sigs.github.io/metrics-server/",
    repoType: "helm",
    description: "resource metrics API for autoscaling and live usage",
  },
  {
    name: "grafana",
    displayName: "Grafana",
  ...
  },
  {
    ...
    repoType: "helm",
    description: "NGINX-based Kubernetes ingress controller",
  },
  {
    name: "external-dns",
    ...
    repoType: "helm",
    description: "DNS synchronization for Kubernetes routes and services",
  },
  {
    name: "vmware-tanzu",
  ...
  },
  {
    ...
    repoType: "helm",
    description: "OpenTelemetry operators and collectors",
  },
  {
    name: "kedacore",
    displayName: "KEDA",
    ...
    repoType: "helm",
    description: "event-driven Kubernetes autoscaling",
  },
  {
    name: "cnpg",
    ...
    repoType: "helm",
    description: "highly available PostgreSQL operator",
  },
  {
    name: "dhi",
