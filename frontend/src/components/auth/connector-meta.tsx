...
export const CONNECTOR_META: Record<string, ConnectorTypeMeta> = {
  microsoft: {
    ...
    fields: {
      ...
      groups: {
        ...
        list: true,
        helper: "Comma-separated group object IDs",
      },
    },
  },
  oidc: {
  ...
  saml: {
    ...
    fields: {
      ...
      entityIssuer: {
        label: "Entity issuer",
        placeholder: "urn:astronomer:dex",
      },
      caData: {
        label: "IdP CA (PEM)",
        multiline: true,
        helper: "Paste the IdP signing certificate",
      },
      ca: {
        label: "IdP CA path",
        helper: "Alternative to CA data — file path inside Dex pod",
      },
  ...
  ldap: {
    ...
    fields: {
      ...
      bindDN: {
        label: "Bind DN",
        placeholder: "cn=dex,ou=service,dc=example,dc=com",
      },
