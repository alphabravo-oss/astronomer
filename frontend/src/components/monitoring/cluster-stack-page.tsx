      ...
      {!permissions.read.allowed ? (
        ...
        <div className="space-y-4">
          ...
          {sharedThanosStorageId ? (
            <p
              className="text-sm text-muted-foreground"
              data-testid="shared-thanos-bucket-prefill"
            >
              Use shared Thanos bucket. Object storage is pre-filled from the
              healthy shared Thanos stack. This does not enable Thanos Receive
              or remote_write.
            </p>
          ) : null}
