...
const rawPalette =
  /\b(?:text|bg|border|ring)-(?:gray|slate|zinc|neutral|stone|red|orange|amber|yellow|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-[0-9]+\b/;
      ...
      for (const entry of readdirSync(dir, { withFileTypes: true })) {
        ...
        if (entry.isDirectory()) walk(path);
          ...
          if (
            ...
            !intentionalVisualPalettes.has(relative) &&
            rawPalette.test(readFileSync(path, "utf8"))
          )
