...
| [008-enterprise-grade-api-and-rancher-parity-implementation-plan.md](./008-enterprise-grade-api-and-rancher-parity-implementation-plan.md) | **IN PROGRESS — v1.1+ enterprise implementation authority** | Implements all 20 findings from the 2026-08-23 deep audit: authorization, task ownership, allow-list enforcement, release/upgrade gates, durable audit and CIS workflows, agent compatibility, complete OpenAPI/generated clients, pagination, measured scale, explorer/accessibility/browser/logging UX, decomposition, and Flux-current documentation. |
| [009-three-host-k3s-rke2-astronomer-constellation-e2e-qualification-plan.md](./009-three-host-k3s-rke2-astronomer-constellation-e2e-qualification-plan.md) | **TODO — P0 physical interoperability qualification** | Self-contained destructive campaign for a separate three-node Astronomer/Constellation management cluster plus three disposable targets. Requires three repetitions each of single-node and three-server HA K3s/RKE2, API-driven Astronomer adoption and Flux/workload lifecycle, real Constellation vulnerability/traffic evidence, independent probes, signed artifacts, and exact cleanup fences. Constellation contract discovery is a mandatory first gate because that repository is not present in this checkout. |
