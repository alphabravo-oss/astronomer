...
| [025 — Guided form depth and table parity](./025-guided-form-depth-and-table-parity.md) | P2 · L | **TODO — READY**, next feature phase; reconcile original excerpts against the integrated tree first | `ArrayField` for containers/rules/volumes/env/ports/paths/tolerations/affinity, group-by-namespace, bulk restart/scale, generic related resources, `questions.yaml` ADR spike. |
