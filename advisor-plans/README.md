...
| [020 — Cluster explorer nav: discovery + CRD groups](./020-cluster-explorer-nav-discovery-and-crd-groups.md) | P2 · L | TODO — READY (018, 019 done; needs a `starred_types` migration — see plan note) | `ifHaveGroup` gating, Gateway API folded into Service Discovery, dynamic More Resources subgroups, starred types (adds `starred_types` pref). |
