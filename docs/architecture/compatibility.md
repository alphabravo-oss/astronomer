...
This table describes the `1.1.x` release line. Install mode is **fresh and upgrade**. Supported upgrades begin at schema 1 and migrate to schema 47.
...
| PostgreSQL | 16, 17; TLS required in production; schemas 1-47 supported for upgrade |
