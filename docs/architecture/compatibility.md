...
This table describes the `1.2.x` release line. Install mode is **fresh and upgrade**. Supported upgrades begin at schema 1 and migrate to schema 60.
...
| PostgreSQL | 16, 17; TLS required in production; schemas 1-60 supported for upgrade |
