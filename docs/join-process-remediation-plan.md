...
| C3 | Metrics-stale + state replay | M13,L12 | 4 | M | [x] RESOLVED 6a6cbef (G-C3 live: MetricsFlowing/Stale/NoMetricsServer distinct, status stays active; StateSubscriber replay unit-tested) |
...
| F3 | Bootstrap-token re-apply hygiene | L4,L17 | 4 | M | [x] RESOLVED (documented re-apply caveat + --server-side guidance on the token Secret) |
