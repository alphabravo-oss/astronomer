...
| `internal/tunnel` | Server-side agent connection lifecycle, stream proxying, internal Kubernetes/Helm request relays, tunnel metrics/audit hooks. | Domain state transitions that belong in handlers/workers. |
