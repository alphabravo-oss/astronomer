...
- Frontend source lines: 90201
- Go source files under `internal/` excluding generated sqlc and tests: 428
- Go source files scanned for sqlc query references excluding generated sqlc: 1006
