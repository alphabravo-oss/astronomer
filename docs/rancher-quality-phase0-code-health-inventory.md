...
- Frontend source files: 314
- Frontend source lines: 89889
- Go source files under `internal/` excluding generated sqlc and tests: 420
- Go source files scanned for sqlc query references excluding generated sqlc: 971
...
- `bearerToken` in [`internal/handler/scim.go:196`](internal/handler/scim.go:196), [`internal/server/routes.go:1912`](internal/server/routes.go:1912)
