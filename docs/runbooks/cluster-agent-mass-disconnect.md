# Runbook — Cluster-agent mass disconnect

**Severity**: page (multi-cluster outage)
**Component**: `internal/tunnel` server-side, cluster agents
...
3. **Agent token rotation?** If a bulk token rotation went
